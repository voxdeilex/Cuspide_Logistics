<?php
    ...
    $body .= "<tr><td colspan='2' style='border:none;'>{$radio1}</td></tr>";
    $body .= "<tr><td colspan='2' style='border:none;'>{$radio2}</td></tr>";
    $body .= "<tr><td colspan='2' style='border:none;'>{$radio4}</td></tr>";
    $body .= "<tr><td colspan='2' style='border:none;'>{$radio5}</td></tr>";
	$body .= "<tr><td></td></tr>";
